...
//**********************************************************************
     ...
     * @param filepath Environment.DIRECTORY_MOVIES / Environment.DIRECTORY_DCIM etc.
     * @param filename .mp4(.m4a for audio) or .png
     * @return return null when this app has no writing permission to external storage.
     */
    public static final File getCaptureFile(final String filepath, String filename) {
		final File dir = new File(filepath);
        Log.d(TAG, "path=" + dir.toString());
		dir.mkdirs();
        //filename = getDateTimeString()+".png";
        if (dir.canWrite()) {
